        ...
        <div>
              ...
              <div className="row">
                <div className="col-12 col-md-6 col-lg-4">
                  ...
                  >
                    <h4>Hiking Trails</h4>
                    <p>
                      Discover the best hiking trails around the world. From
                      easy walks to challenging climbs, we cover them all.
                    </p>
                  </div>
                </div>
                <div className="col-12 col-md-6 col-lg-4">
                  ...
                  >
                    ...
                    <p>
                      Experience the thrill of wildlife safaris in exotic
                      locations. Get up close and personal with nature's most
          ...
          <section className="pixel-prices-area d-flex flex-wrap section-padding-100">
            ...
            <div className="single-price-table-area mb-100">
              ...
              <p>
                Enhanced access with additional perks and exclusive content.
              </p>
              <ul className="price-desc">
                <li>
                  <img src="img/core-img/correct.png" alt="" /> All Explorer
                  Pack features
                </li>
                <li>
                ...
                <li>
                  <img src="img/core-img/correct.png" alt="" /> Full photo
                  gallery access
                </li>
                <li>
                ...
                <li>
                  <img src="img/core-img/correct.png" alt="" /> Personalized
                  trip advice
                </li>
              </ul>
              <a href="#" className="btn pixel-btn">
            ...
            <div className="single-price-table-area active mb-100">
              ...
              <h2>Explorer Pack</h2>
              <p>
                Comprehensive access with premium content and personalized
                services.
              </p>
              <ul className="price-desc">
                <li>
                  <img src="img/core-img/correct.png" alt="" /> All Adventurer
                  Pack features
                </li>
                <li>
                  <img src="img/core-img/correct.png" alt="" /> Weekly travel
                  guides
                </li>
                <li>
            ...
            <div className="single-price-table-area mb-100">
              ...
              <h2>Platinum Pack</h2>
              <p>
                All-inclusive access with VIP perks and personalized services.
              </p>
              <ul className="price-desc">
                <li>
                  <img src="img/core-img/correct.png" alt="" /> All Explorer
                ...
                <li>
                  <img src="img/core-img/correct.png" alt="" /> VIP travel
                  events
                </li>
                <li>
                  <img src="img/core-img/caution.png" alt="" /> Dedicated
                  support
                </li>
                <li>
                  <img src="img/core-img/correct.png" alt="" /> Annual travel
                  gift box
                </li>
              </ul>
              <a href="#" className="btn pixel-btn">
              ...
              <div className="row">
                <div className="col-12 col-md-6 col-lg-3">
                  ...
                  >
                    ...
                    <h5>Guided Hikes</h5>
                    <p>
                      Explore nature with our experienced guides on trails
                ...
                <div className="col-12 col-md-6 col-lg-3">
                  ...
                  >
                    ...
                    <h5>Camping Trips</h5>
                    <p>
                      Experience the great outdoors with our well-planned
                      camping trips for all ages.
                    </p>
                    <a href="#" className="btn">
                      More Info
                    </a>
